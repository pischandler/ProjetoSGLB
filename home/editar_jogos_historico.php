...
try {
    ...
    $edit_event->bindParam(':title', $dados['edit_title_historico']);
    $edit_event->bindParam(':color', $dados['edit_color_historico']);
    $edit_event->bindParam(':start', $dados['edit_start_historico']);
    $edit_event->bindParam(':end', $dados['edit_end_historico']);
    $edit_event->bindParam(':genero', $dados['edit_genero_historico']);
    $edit_event->bindParam(':adversario', $dados['edit_adversario_historico']);
    $edit_event->bindParam(':cidade_id', $dados['edit_cidade_historico']);
    $edit_event->bindParam(':rua', $dados['edit_rua_historico']);
    $edit_event->bindParam(':local', $dados['edit_local_historico']);
    $edit_event->bindParam(':cep', $dados['edit_cep_historico']);
    $edit_event->bindParam(':bairro', $dados['edit_bairro_historico']);
    $edit_event->bindParam(':numero', $dados['edit_numero_historico']);
    $edit_event->bindParam(':complemento', $dados['edit_complemento_historico']);
    $edit_event->bindParam(':id', $dados['edit_id_historico']);
    $edit_event->execute();
    ...
    $delete_modalidade_jogo->bindParam(':jogo_id', $dados['edit_id_historico']);
    ...
    $insert_modalidade_jogo->bindParam(':modalidade_id', $dados['edit_modalidade_historico']);
    $insert_modalidade_jogo->bindParam(':jogo_id', $dados['edit_id_historico']);
    ...
    $delete_associado_jogo->bindParam(':jogo_id', $dados['edit_id_historico']);
    ...
    if (!empty($dados['associados'])) {
        ...
        foreach ($dados['associados'] as $associado_id) {
            ...
            $insert_associado_jogo->bindParam(':jogo_id', $dados['edit_id_historico']);
    ...
    $get_event_details->bindParam(':id', $dados['edit_id_historico']);
    ...
    $get_modalidade->bindParam(':jogo_id', $dados['edit_id_historico']);
    ...
    $get_associados->bindParam(':jogo_id', $dados['edit_id_historico']);
